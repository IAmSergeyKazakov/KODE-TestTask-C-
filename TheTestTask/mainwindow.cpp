...
void MainWindow::setLetterCombobox()
{
    ...
    {
        index = dataModel->index(i,1, QModelIndex());
...
void MainWindow::setTypesCombobox()
{
    ...
    for (int i = 0; i < rowCount; i++)
    {
        ...
        {
            index2 = dataModel->index(j,4, QModelIndex());
            indexString2 = ui->tableViewForData->model()->data(index2).toString();
            ...
            if(ui->typeSort->findText(indexString) == -1 && count > 1)
            {
                ...
                qDebug()<<indexString << " added; "<<"count = 0";
            }
...
void MainWindow::on_add_button_clicked()
{
    ...
    QString name = ui->fillName->text().toLower();
    letter = name[0];
